...
layer_background_sprite(back_id, spr_bg_1);


layer_background_sprite(back_id1, spr_bg_8);


layer_background_sprite(back_id2, spr_bg_2);


layer_background_sprite(back_id3, spr_bg_14);


//layer_background_sprite(back_id4, spr_bg_18);


layer_background_sprite(back_id5, spr_bg_6);
