...
layer_background_sprite(back_id, spr_bg_16);


layer_background_sprite(back_id1, spr_bg_4);


layer_background_sprite(back_id2, spr_bg_5);


layer_background_sprite(back_id3, spr_bg_13);


//layer_background_sprite(back_id4, spr_bg_13);


layer_background_sprite(back_id5, spr_bg_7);

var whatever =  sprite_get_height(spr_bg_16)-camera_get_view_height(view_camera[0]);
